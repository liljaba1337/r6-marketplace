...
namespace r6_marketplace.RequestBodies.AccountData.GetBalance
{
...
namespace r6_marketplace.RequestBodies.AccountData.GetInventory
{
    internal class Root : RequestRoot<Variables>
    {
    ...
    internal class Variables : BaseVariables
    {
        ...
        public bool withOwnership { get; } = false;
